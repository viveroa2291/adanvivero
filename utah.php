    ...
    <main>
            ...
            <div class="body-images">
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Salt Lake City Mormon Church</div>
                        <img class="utah-images not-wide" src="states-images/utah-images/church-me.jpeg" alt="This is a picture of me in front of a <br> mormon church in Salt Lake City.">
                ...
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Salt Lake City Mormon Church</div>
                        <img class="utah-images not-wide" src="states-images/utah-images/church.jpeg" alt="This is an image of a mormon church in <br> Salt Lake City.">
                        <div class="card-body m-1">
                            <h5 class="card-title text-center" id="cardTitle"></h5>
                            <hr>
                ...
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Salt Lake City Mormon Church</div> 
                        <img class="utah-images not-wide" src="states-images/utah-images/church-mom.jpeg" alt="This is a picture of my mother and I <br> at a mormon church in Salt Lake City.">
                        <div class="card-body m-1">
                            <h5 class="card-title text-center" id="cardTitle"></h5>
                            <hr>
        ...
        <section>
            <div class="body-images">
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Arches National Park</div>
                    <img class="utah-images not-wide" src="states-images/utah-images/arches.jpeg" alt="This is an image of me at the Arches <br> National Park.">
                    <div class="card-body m-1">
                        <h5 class="card-title text-center" id="cardTitle"></h5>
                        <hr>
                ...
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Arches National Park</div>
                        <img class="utah-images not-wide" src="states-images/utah-images/big-arch.jpeg" alt="This is an image of me at the heart of the <br> arch of the Arches National Park.">
                        <div class="card-body m-1">
                            <h5 class="card-title text-center" id="cardTitle"></h5>
                            <hr>
                ...
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Arches National Park</div>
                        <img class="utah-images not-wide" src="states-images/utah-images/small-arch.jpeg" alt="This is an image of me inside a small arch <br> with a view of the big arch at the Arches <br> National Park.">
                        <div class="card-body m-1">
                            <h5 class="card-title text-center" id="cardTitle"></h5>
                            <hr>
        ...
        <section>
            <div class="body-images">
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Arches National Park</div>
                        <img class="utah-images wide" src="states-images/utah-images/arch-field.jpeg" alt="This is an image of me looking at a field at the Arches National Park. <br> It was a gigantic field and it was pretty cool.">
                        <div class="card-body m-1">
                            <h5 class="card-title text-center" id="cardTitle"></h5>
                            <hr>
        ...
        <section>
            <div class="body-images">
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Arches National Park</div>
                        <img class="utah-images not-wide" src="states-images/utah-images/arches3.jpeg" alt="This is an image of me at an open area <br> at the Arches National Park.">
                        <div class="card-body m-1">
                            <h5 class="card-title text-center" id="cardTitle"></h5>
                            <hr>
            ...
            <div class="body-images">
                <div class="card m-5" id="cardBody">
                    ...
                    <img class="utah-images wide" src="states-images/utah-images/mountains.jpeg" alt="This is an image of me at Springville Utah standing at the middle <br> of a mountain.">
                    <div class="card-body m-1">
                        <h5 class="card-title text-center" id="cardTitle"></h5>
                        <hr>
                ...
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Springville, Utah</div>
                    <img class="utah-images wide" src="states-images/utah-images/mountains3.jpeg" alt="This is an image of me at Springville Utah standing at the middle <br> of a mountain.">
                    <div class="card-body m-1">
                        <h5 class="card-title text-center" id="cardTitle"></h5>
                        <hr>
                        <p class="card-text" id="description">This is an image of me at Springville Utah standing at the middle <br> of a mountain.</p>
        ...
        <section>
            <div class="body-images">
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Springville, Utah</div>
                    <img class="utah-images not-wide" src="states-images/utah-images/mountains2.jpeg" alt="This is an image of me at Springville Utah <br> standing at the bottom of the mountains.">
                    <div class="card-body m-1">
                        <h5 class="card-title text-center" id="cardTitle"></h5>
                        <hr>
                ...
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Springville, Utah</div>
                    <img class="utah-images not-wide" src="states-images/utah-images/mountains4.jpeg" alt="This is an image of me at Springville Utah <br> standing at the center of the mountains.">
                    <div class="card-body m-1">
                        <h5 class="card-title text-center" id="cardTitle"></h5>
                        <hr>
                ...
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Springville, Utah</div>
                    <img class="utah-images not-wide" src="states-images/utah-images/mountains5.jpeg" alt="This is an image of me at Springville Utah <br> standing at the bottom of the mountains.">
                    <div class="card-body m-1">
                        <h5 class="card-title text-center" id="cardTitle"></h5>
                        <hr>
                        <p class="card-text" id="description">This is an image of me at Springville Utah <br> standing at the bottom of the mountains.</p>
        ...
        <section>
            ...
            <div class="body-images">
                <div class="card m-5" id="cardBody">
                    ...
                    <img class="utah-images not-wide" src="states-images/utah-images/draper.jpeg" alt="This is an image of me at Draper, Utah <br> which was a nice view of the city.">
                    <div class="card-body m-1">
                        <h5 class="card-title text-center" id="cardTitle"></h5>
                        <hr>
                ...
                <div class="card m-5" id="cardBody">
                    ...
                    <img class="utah-images not-wide" src="states-images/utah-images/outside.jpeg" alt="This is an image of me standing outside <br> of my cousins house in Utah. I really like <br> the cool view of the mountains.">
                    <div class="card-body m-1">
                        <h5 class="card-title text-center" id="cardTitle"></h5>
                        <hr>
        ...
        <section>
            <div class="body-images">
                <div class="card m-5" id="cardBody">
                    <div class="card-header text-center" id="featureTitle">Utah</div>
                    <img class="utah-images wide" src="states-images/utah-images/pauls-house.jpeg" alt="This is an image of me standing outside my other cousins house <br> in Utah. Again, I really find the mountains a view cool view right <br> outside their house.">
                    <div class="card-body m-1">
                        <h5 class="card-title text-center" id="cardTitle"></h5>
                        <hr>
        ...
        <div id="myModal" class="modal">
            ...
            <div class="row">
                    <img class="box-image" src="states-images/utah-images/church-me.jpeg" onclick="image(1)" alt="This is a picture of me in front of a <br> mormon church in Salt Lake City.">
                    <img class="box-image" src="states-images/utah-images/church.jpeg" onclick="image(2)" alt="This is an image of a mormon church in <br> Salt Lake City.">
                    <img class="box-image" src="states-images/utah-images/church-mom.jpeg" onclick="image(3)" alt="This is a picture of my mother and I <br> at a mormon church in Salt Lake City.">
                    ...
                    <img class="box-image" src="states-images/utah-images/arches.jpeg" onclick="image(8)" alt="This is an image of me at the Arches <br> National Park.">
                    <img class="box-image" src="states-images/utah-images/big-arch.jpeg" onclick="image(9)" alt="This is an image of me at the heart of the <br> arch of the Arches National Park.">
                    <img class="box-image" src="states-images/utah-images/small-arch.jpeg" onclick="image(10)" alt="This is an image of me inside a small arch <br> with a view of the big arch at the Arches <br> National Park.">
            </div>
            <div class="row">
                    <img class="box-image" src="states-images/utah-images/arch-field.jpeg" onclick="image(11)" alt="This is an image of me looking at a field at the Arches National Park. <br> It was a gigantic field and it was pretty cool.">
                    ...
                    <img class="box-image" src="states-images/utah-images/arches3.jpeg" onclick="image(13)" alt="This is an image of me at an open area <br> at the Arches National Park.">
                    <img class="box-image" src="states-images/utah-images/mountains.jpeg" onclick="image(14)" alt="This is an image of me at Springville Utah standing at the middle <br> of a mountain.">
                    <img class="box-image" src="states-images/utah-images/mountains3.jpeg" onclick="image(15)" alt="This is an image of me at Springville Utah standing at the middle <br> of a mountain.">
                    <img class="box-image" src="states-images/utah-images/mountains2.jpeg" onclick="image(16)" alt="This is an image of me at Springville Utah <br> standing at the bottom of the mountains.">
                    <img class="box-image" src="states-images/utah-images/mountains4.jpeg" onclick="image(17)" alt="This is an image of me at Springville Utah <br> standing at the center of the mountains.">
                    <img class="box-image" src="states-images/utah-images/mountains5.jpeg" onclick="image(18)" alt="This is an image of me at Springville Utah <br> standing at the bottom of the mountains.">
                    <img class="box-image" src="states-images/utah-images/draper.jpeg" onclick="image(19)" alt="This is an image of me at Draper, Utah <br> which was a nice view of the city.">
                    <img class="box-image" src="states-images/utah-images/outside.jpeg" onclick="image(20)" alt="This is an image of me standing outside <br> of my cousins house in Utah. I really like <br> the cool view of the mountains.">
                    <img class="box-image" src="states-images/utah-images/pauls-house.jpeg" onclick="image(21)" alt="This is an image of me standing outside my other cousins house <br> in Utah. Again, I really find the mountains a view cool view right <br> outside their house.">
            </div>
            <div id="caption"></div>
        </div>
    </main>
