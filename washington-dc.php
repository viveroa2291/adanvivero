...
<header>
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav top-links">
                        ...
                        ?>
                        <p class="title">Washington D.C.</p>
                        <p class="slash">/</p>
                    </div>
                </div>
            </div>
    ...
    <main>
    <h1>Washington D.C. Coming soon</h1>
    <section class="bottom-section">
            <span><a class="previous-state" href="utah.php">&#60;</a></span>
            <p class="other-states"><b>Check out the other states</b></p>
            <span><a class="next-state" href="west-virginia.php">&#62;</a></span>
        </section>
    </main>
    <?php 
